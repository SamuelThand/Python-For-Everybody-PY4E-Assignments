...
you are requesting as the address= parameter that is properly URL encoded using the urllib.parse.urlencode() function as shown in http://www.py4e.com/code3/geojson.py
...
Hint: The first seven characters of the place_id are "ChIJdZL ..."
...
while True:
    ...
    print('Encoded url to be opened:',url)
