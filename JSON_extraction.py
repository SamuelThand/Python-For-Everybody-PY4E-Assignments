...
One is a sample file where we give you the sum for your testing and the other is the actual data you need to process for the assignment.
    ...
    Actual data: http://py4e-data.dr-chuck.net/comments_1084977.json (Sum ends with 0)
...
url = 'http://py4e-data.dr-chuck.net/comments_1084977.json'
data_ = urllib.request.urlopen(url, context=ctx).read().decode()

#print(data_)
info = json.loads(data_)
