...
One is a sample file where we give you the sum for your testing and the other is the actual data you need to process for the assignment.
    ...
    Actual data: http://py4e-data.dr-chuck.net/comments_1084974.html (Sum ends with 91)
...
url = 'http://py4e-data.dr-chuck.net/comments_1084974.html'
...
count=0
for tag in tags:
    intcontent = int(tag.contents[0])
    count = count + intcontent
    # Look at the parts of a tag
    #print('TAG:', tag)
    #print('URL:', tag.get('href', None))
    #print('Contents:', tag.contents[0])
